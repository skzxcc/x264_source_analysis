...
***这里说的SAD/SATD不单单是sad/satd计算得到的值还会加上相关的lambda×R，详细见”宏块分析之帧内编码.md“和”宏块分析之帧间编码.md“***
...
注意除了x264_lambda2_tab还有**x264_lambda_tab**，两者是不一样的。**前者是用于ssd的率失真计算(也就是本文要将的内容)**，后者是用于sad/satd的率失真计算的
